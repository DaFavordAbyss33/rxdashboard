...
export const BOT_TOKENS = {
  ...
  "syruprx-pro": process.env.DISCORD_BOT_TOKEN_SYRUPRX_PRO!,
  autoclockrx: process.env.DISCORD_BOT_TOKEN_AUTOCLOCKRX!,
  mednoterx: process.env.DISCORD_BOT_TOKEN_MEDNOTERX!,
